...
- **Awesome Copilot Workflows** ([Awesome Copilot Workflows](https://awesome-copilot.github.com/workflows/))
  ...
  - *OSPO Organization Health Report*: Weekly health report for a GitHub organization, surfacing stale issues/PRs, merge time analysis, contributor leaderboards, and actionable items needing human attention.
